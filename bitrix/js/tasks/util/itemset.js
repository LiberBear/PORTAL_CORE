	...
	BX.Tasks.Util.ItemSet = BX.Tasks.Util.Widget.extend({
		...
		methods: {
            ...
            bindItemActions: function()
            {
                ...
                this.bindDelegateControl('item-delete', 'click', this.passCtx(this.onItemDeleteClicked));
            },
        ...
        methods: {
            ...
            appear: function(parameters)
            {
                if(!parameters.dontRender && !parameters.load) // no fx on pre-rendered and .load()-ed blocks
                {
                    ...
                    {
                        BX.Tasks.Util.fadeToggleByClass(this.scope(), 200);
                    }
                }
            },
            ...
            disappear: function(complete, parameters)
            {
                ...
                {
                    BX.Tasks.Util[fx == 'horizontal' ? 'fadeSlideHToggleByClass' : 'fadeSlideToggleByClass'](this.scope(), 200, BX.delegate(complete, this));
                }
            }
        }
    });
