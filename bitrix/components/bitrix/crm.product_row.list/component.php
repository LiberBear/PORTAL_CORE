...
$arResult['TOTAL_DISCOUNT'] = isset($arParams['TOTAL_DISCOUNT']) ? (double)$arParams['TOTAL_DISCOUNT'] : $totalDiscount;
$arResult['TOTAL_SUM'] = isset($arParams['TOTAL_SUM']) ? (double)$arParams['TOTAL_SUM'] : $totalSum;
$arResult['TOTAL_TAX'] = isset($arParams['TOTAL_TAX']) ? (double)$arParams['TOTAL_TAX'] : $totalTax;
