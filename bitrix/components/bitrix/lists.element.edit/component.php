...
)
{
	...
	)
	{
		...
		if(!$strError)
		{
			...
			$elementId = $arResult["ELEMENT_ID"] ? $arResult["ELEMENT_ID"] : $res;
			if($attachFileDisk && $elementId)
			{
				...
				{
					CIBlockElement::setPropertyValuesEx($elementId, $arResult["IBLOCK_ID"], $propertyValues);
				}
			}
		}
