					...
					array(
						...
						'configs' => array(
							...
							array(
								...
								'format' => array('isCurrency' => 'Y', 'enableDecimals' => 'N')
								//'display' => array('colorScheme' => 'cyan')
							)
						)
					)
				)
...
?><div class="bx-crm-view"><?
	$APPLICATION->IncludeComponent(
		...
		array(
			...
			'PATH_TO_WIDGET' => isset($arResult['PATH_TO_DEAL_WIDGET']) ? $arResult['PATH_TO_DEAL_WIDGET'] : '',
			'PATH_TO_LIST' => isset($arResult['PATH_TO_DEAL_LIST']) ? $arResult['PATH_TO_DEAL_LIST'] : '',
