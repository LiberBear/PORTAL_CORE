...
else
{
	...
	)
	{
		...
		)
		{
			...
			\Bitrix\Main\Data\AppCacheManifest::getInstance()->addAdditionalParam("preventAutoUpdate", "Y");
	...
	)
	{
		...
		if ($arParams["NEW_LOG_ID"] <= 0)
		{
			$GLOBALS["APPLICATION"]->sPath2css = array();
			$GLOBALS["APPLICATION"]->arHeadScripts = array();
		}
	}
