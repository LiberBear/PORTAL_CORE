...
if(isset($_GET['ACTIVE_TAB']))
	$arResult['ACTIVE_TAB'] = $_GET['ACTIVE_TAB'];
else
...
/* The data system fields from different settings */
$arResult['ENTITY'] = array();
$arResult['ENTITY']['DEAL_STAGE']['START_FIELD'] = 'NEW';
$arResult['ENTITY']['DEAL_STAGE']['FINAL_SUCCESS_FIELD'] = 'WON';
$arResult['ENTITY']['DEAL_STAGE']['FINAL_UNSUCCESS_FIELD'] = 'LOSE';
$arResult['ENTITY']['DEAL_STAGE']['FINAL_SORT'] = 0;
$arResult['ENTITY']['STATUS']['START_FIELD'] = 'NEW';
$arResult['ENTITY']['STATUS']['FINAL_SUCCESS_FIELD'] = 'CONVERTED';
$arResult['ENTITY']['STATUS']['FINAL_UNSUCCESS_FIELD'] = 'JUNK';
$arResult['ENTITY']['STATUS']['FINAL_SORT'] = 0;
$arResult['ENTITY']['QUOTE_STATUS']['START_FIELD'] = 'DRAFT';
$arResult['ENTITY']['QUOTE_STATUS']['FINAL_SUCCESS_FIELD'] = 'APPROVED';
$arResult['ENTITY']['QUOTE_STATUS']['FINAL_UNSUCCESS_FIELD'] = 'DECLAINED';
$arResult['ENTITY']['QUOTE_STATUS']['FINAL_SORT'] = 0;
$arResult['ENTITY']['INVOICE_STATUS']['START_FIELD'] = 'N';
$arResult['ENTITY']['INVOICE_STATUS']['FINAL_SUCCESS_FIELD'] = 'P';
$arResult['ENTITY']['INVOICE_STATUS']['FINAL_UNSUCCESS_FIELD'] = 'D';
$arResult['ENTITY']['INVOICE_STATUS']['FINAL_SORT'] = 0;
...
while($ar = $res->Fetch())
{
	...
	if(!empty($settings))
	{
		$arResult['ROWS'][$ar['ENTITY_ID']][$ar['ID']]['COLOR'] = $settings[$ar['ENTITY_ID']][$ar['STATUS_ID']]['COLOR'];
	}

	if($arResult['ENTITY'][$ar['ENTITY_ID']]['FINAL_SUCCESS_FIELD'] == $ar['STATUS_ID'])
	{
		$arResult['ENTITY'][$ar['ENTITY_ID']]['FINAL_SORT'] = $ar['SORT'];
	}
}
/*
