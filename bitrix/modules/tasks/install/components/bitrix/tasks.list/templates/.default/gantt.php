...
// converting calendar settings to js notation
$h = $arResult['CALENDAR_SETTINGS']['HOURS'];
$cs = $arResult['CALENDAR_SETTINGS'];
...
$holidays = array();
if(is_array($cs['HOLIDAYS']))
{
	foreach($cs['HOLIDAYS'] as $day)
	{
		$holidays[] = array(
...
$weekEnds = array($dayMap[$cs['WEEKEND'][0]], $dayMap[$cs['WEEKEND'][1]]);
$weekStart = $dayMap[$cs['WEEK_START']];
