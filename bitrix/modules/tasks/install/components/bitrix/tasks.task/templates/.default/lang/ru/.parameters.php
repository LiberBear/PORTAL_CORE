...
$MESS['TASKS_TASK_TEMPLATE_PATH_TO_GROUP_TASKS'] = 'Путь к списку задач';
$MESS['TASKS_TASK_TEMPLATE_PATH_TO_GROUP_TASKS_TASK'] = 'Путь к задаче';
$MESS['TASKS_TASK_TEMPLATE_PATH_TO_USER_PROFILE'] = 'Путь к профилю пользователя';
$MESS['TASKS_TASK_TEMPLATE_PATH_TO_GROUP'] = 'Путь к группе';
$MESS['TASKS_TASK_TEMPLATE_SHOW_RATING'] = 'Включить рейтинг';
$MESS['TASKS_TASK_TEMPLATE_RATING_TYPE'] = 'Вид кнопок рейтинга';
$MESS['TASKS_TASK_TEMPLATE_RATING_TYPE_CONFIG'] = 'по умолчанию';
$MESS['TASKS_TASK_TEMPLATE_RATING_TYPE_LIKE_TEXT'] = 'Нравится / Не нравится (текстовый)';
$MESS['TASKS_TASK_TEMPLATE_RATING_TYPE_LIKE_GRAPHIC'] = 'Нравится / Не нравится (графический)';
$MESS['TASKS_TASK_TEMPLATE_RATING_TYPE_STANDART_TEXT'] = 'Мне нравится (текстовый)';
$MESS['TASKS_TASK_TEMPLATE_RATING_TYPE_STANDART_GRAPHIC'] = 'Мне нравится (графический)';
$MESS['TASKS_TASK_TEMPLATE_REDIRECT_ON_SUCCESS'] = 'Выполнять редирект на url возврата при успешном сохранении';
