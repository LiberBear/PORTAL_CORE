			...
			<div data-bx-id="checklist-item-appearance" data-item-id="{{ID}}" class="tasks-checklist-item mode-read {{APPEARANCE}} {{READONLY}}">
				<div class="task-checklist-field generic">
					<div class="task-checklist-field-inner">
						...
						<?//edit mode?>
						<input data-bx-id="checklist-item-title-edit" class="block-edit task-checklist-field-add" type="text" value="{{TITLE}}" name="<?=$prefix?>[{{ID}}][TITLE]" placeholder="<?=Loc::getMessage('TASKS_TTDP_CHECKLIST_WHAT_TO_BE_DONE')?>" />
	...
	<?if($canAddOwn):?>
		<div data-bx-id="checklist-add-item-form" class="task-checklist-field tasks-checklist-dropzone off">
			<span class="block-on task-checklist-field-inner-add">
				<input data-bx-id="checklist-add-item-title" type="text" class="task-checklist-field-add" placeholder="<?=Loc::getMessage('TASKS_TTDP_CHECKLIST_WHAT_TO_BE_DONE')?>" />
				<span data-bx-id="checklist-add-item-form-open" class="block-edit task-field-title-ok"></span>
