...
<div id="bx-component-scope-<?=htmlspecialcharsbx($templateId)?>" class="task-options-repeat">
    ...
    <div class="task-options-field">
        <div class="task-options-field task-options-field-left">
            ...
            <span data-bx-id="replication-timepicker" class="task-options-inp-container task-options-inp-container-period task-options-inp-container-timer">
                <input id="ttd" data-bx-id="timepicker-display" type="text" class="task-options-inp" placeholder="HH:MM" readonly="readonly" />
	            <input id="ttv" data-bx-id="replication-time timepicker-value" name="<?=$prefix?>[TIME]" type="hidden" value="<?=htmlspecialcharsbx($data['TIME'])?>" />
	        ...
	        <span class="js-bx-id-hint-help task-options-timezone-indicator"><?=Loc::getMessage('TASKS_TTDP_REPLICATION_TZ_HINT', array('#TIMEZONE#' => \Bitrix\Tasks\UI::formatTimezoneOffsetUTC($tzOffset)))?></span>
    ...
    <div class="task-options-field task-options-field-nol">
        ...
        <div class="task-options-field task-options-field-left">
            <input data-bx-id="replication-repeat-till" name="<?=$prefix?>[REPEAT_TILL]" value="date" class="task-options-radio" id="replication-repeat-constraint-date" type="radio">
        ...
        <div class="task-options-field task-options-field-left">
            ...
            <span class="task-option-fn"><label for="id91" class="task-field-label"><?=Loc::getMessage('TASKS_TTDP_REPLICATION_REPEATS')?></label></span>
        </div>
    </div>
