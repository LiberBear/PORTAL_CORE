...
Class tasks extends CModule
{
	...
	function InstallDB($arParams = array())
	{
		...
		RegisterModuleDependences('mail', 'onReplyReceivedTASKS_TASK', 'tasks', '\Bitrix\Tasks\Integration\Mail\Task', 'onReplyReceived');
		RegisterModuleDependences('mail', 'onForwardReceivedTASKS_TASK', 'tasks', '\Bitrix\Tasks\Integration\Mail\Task', 'onForwardReceived');
	...
	function UnInstallDB($arParams = array())
	{
		...
		// "mail" module integration
		UnRegisterModuleDependences('mail', 'onReplyReceivedTASKS_TASK', 'tasks', '\Bitrix\Tasks\Integration\Mail\Task', 'onReplyReceived');
		UnRegisterModuleDependences('mail', 'onForwardReceivedTASKS_TASK', 'tasks', '\Bitrix\Tasks\Integration\Mail\Task', 'onForwardReceived');
