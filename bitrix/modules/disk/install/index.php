...
Class disk extends CModule
{
	...
	function GetModuleTasks()
	{
		return array(
			...
			'disk_access_full' => array(
				...
				"BINDING" => "module",
				"OPERATIONS" => array(
					'disk_read', 'disk_add', 'disk_edit', 'disk_settings', 'disk_delete', 'disk_rights', 'disk_sharing', 'disk_start_bp', 'disk_create_wf',
				),
			),
		);
	}
	...
	public static function RegisterModuleDependencies($isAlreadyConverted = true)
	{
		...
		if($isAlreadyConverted)
		{
			RegisterModuleDependences("search", "OnReindex", "disk", "\\Bitrix\\Disk\\IndexManager", "onSearchReindex");
			RegisterModuleDependences("search", "OnSearchGetURL", "disk", "\\Bitrix\\Disk\\IndexManager", "onSearchGetUrl");
