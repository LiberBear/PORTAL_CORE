...
class CCrmLiveFeed
{
	...
	static public function CreateLogEvent(&$fields, $eventType, $options = array())
	{
		...
		$eventFields = array(
			...
			'MESSAGE' => $message,
			'TEXT_MESSAGE' => '',
			'MODULE_ID' => ($eventID == 'crm_activity_add' ? 'crm_shared' : 'crm'),
			'CALLBACK_FUNC' => false,
			'ENABLE_COMMENTS' => 'Y',
	...
	static private function PrepareCounterData($arLogFields)
	{
		...
		if (
			...
			&& in_array(
				...
				array("crm_lead_message", "crm_deal_message", "crm_contact_message", "crm_company_message"))
		)
		{
