		...
		prepareTitle: function(text)
		{
			return (
				BX.create(
					...
					{
						attrs: { className: 'bx-crm-dialog-tittle-wrap' },
						children: [ BX.create('SPAN', { text: text, props: { className: 'bx-crm-dialog-title-text' } }) ]
					}
				)
			);
		},
...
if(typeof(BX.CrmLeadConversionSchemeSelector) === "undefined")
{
	...
	BX.CrmLeadConversionSchemeSelector.prototype.prepageConfig = function()
	{
...
if(typeof(BX.CrmDealConversionSchemeSelector) === "undefined")
{
	...
	BX.CrmDealConversionSchemeSelector.prototype.prepageConfig = function()
	{
...
if(typeof(BX.CrmQuoteConversionSchemeSelector) === "undefined")
{
	...
	BX.CrmQuoteConversionSchemeSelector.prototype.prepageConfig = function()
	{
...
BX.CrmRequisitePresetSelectDialog.prototype =
{
	...
	show: function()
	{
		...
		this._popup = new BX.PopupWindow(
			...
			this.getSetting("anchor", null),
			{
				...
				closeIcon: { top: "10px", right: "15px" },
				zIndex: 0,
				titleBar: { content: this.prepareTitleBarContent() },
				content: this.prepareContent(),
				className : "crm-tip-popup",
				lightShadow : true,
				buttons:
	...
	prepareTitleBarContent: function()
	{
		return (BX.create("SPAN", { attrs: { className: "bx-lists-dialog-title" }, text: this.getMessage("title") }));
	},
...
if(typeof(BX.CrmDataLoader) == "undefined")
{
	...
	BX.CrmDataLoader.prototype =
	{
		initialize: function(id, settings)
		{
			...
			if(!BX.type.isElementNode(this._button))
			{
				throw "BX.CrmDataLoader: button element not found!";
			}
			BX.bind(this._button, "click", this._buttonClickHandler);
			...
			{
				throw "BX.CrmDataLoader: wrapper element not found!";
			}
