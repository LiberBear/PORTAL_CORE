if(typeof(BX.CrmControlPanel) === "undefined")
{
	BX.CrmControlPanel = function()
	{
		...
		this._gridReinitializeHandler = BX.delegate(this._onGridManagerReinitialize, this);
	...
	BX.CrmControlPanel.prototype =
	{
		initialize: function(id, settings)
		{
			...
			BX.addCustomEvent(window, 'BXInterfaceGridManagerReinitialize', this._gridReinitializeHandler);
		},
		...
		_onGridManagerReinitialize: function(manager)
		{
			this.adjust();
		},
