...
class PresetListComponent extends \CBitrixComponent
{
	...
	protected function prepareListHeaders()
	{
		...
		$this->listHeaders = array(
			array('id' => 'ID', 'name' => GetMessage('CRM_REQUISITE_PRESET_ENTITY_ID_FIELD'), 'sort' => 'ID', 'default' => false, 'editable' => false, 'type' => 'int', 'align' => 'right'),
			array('id' => 'NAME', 'name' => GetMessage('CRM_REQUISITE_PRESET_ENTITY_NAME_FIELD'), 'sort' => 'NAME', 'default' => true, 'editable' => true, 'type' => 'text'),
			array('id' => 'ACTIVE', 'name' => GetMessage('CRM_REQUISITE_PRESET_ENTITY_ACTIVE_FIELD'), 'sort' => 'ACTIVE', 'default' => true, 'editable' => array('items' => array('Y' => GetMessage('MAIN_YES'), 'N' => GetMessage('MAIN_NO'))), 'type' => 'list', 'align' => 'center'),
			array('id' => 'SORT', 'name' => GetMessage('CRM_REQUISITE_PRESET_ENTITY_SORT_FIELD'), 'sort' => 'SORT', 'default' => true, 'editable' => true, 'type' => 'int', 'align' => 'right'),
