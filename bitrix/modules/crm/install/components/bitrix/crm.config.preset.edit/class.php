...
class PresetEditComponent extends \CBitrixComponent
{
	...
	{
		$this->listHeaders = array(
			array('id' => 'ID', 'name' => GetMessage('CRM_PRESET_FIELD_ID'), 'sort' => 'ID', 'default' => false, 'editable' => false, 'type' => 'int', 'align' => 'right'),
			...
			array('id' => 'SORT', 'name' => GetMessage('CRM_PRESET_FIELD_SORT'), 'sort' => 'SORT', 'default' => true, 'editable' => true, 'type' => 'int', 'align' => 'right'),
			array('id' => 'IN_SHORT_LIST', 'name' => GetMessage('CRM_PRESET_FIELD_IN_SHORT_LIST'), 'sort' => 'IN_SHORT_LIST', 'default' => true, 'editable' => array('items' => array('Y' => GetMessage('MAIN_YES'), 'N' => GetMessage('MAIN_NO'))), 'type' => 'list', 'align' => 'center'),
		);
