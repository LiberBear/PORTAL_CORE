...
{
	function __CrmQuickPanelViewPrepareClientInfo($entityTypeName, &$entityContext, array $formFieldNames = null)
	{
...
if($entityTypeID === CCrmOwnerType::Contact)
{
	...
	foreach($entityFields as $k => $v)
	{
		...
		elseif($k === 'COMPANY_ID')
		{
			$entityData['COMPANY_ID'] = __CrmQuickPanelViewPrepareClientInfo(CCrmOwnerType::CompanyName, $entityContext, $formFieldNames);
		}
...
elseif($entityTypeID === CCrmOwnerType::Deal)
{
	...
	foreach($entityFields as $k => $v)
	{
		...
		elseif($k === 'CONTACT_ID')
		{
			$entityData['CONTACT_ID'] = __CrmQuickPanelViewPrepareClientInfo(CCrmOwnerType::ContactName, $entityContext, $formFieldNames);
		}
		elseif($k === 'QUOTE_ID')
		{
			$v = (int)$v;
...
elseif($entityTypeID === CCrmOwnerType::Invoice)
{
	...
	foreach($entityFields as $k => $v)
	{
		...
		elseif($k === 'UF_COMPANY_ID')
		{
			...
			$k = 'CLIENT_ID';
			$entityData[$k] = __CrmQuickPanelViewPrepareClientInfo(CCrmOwnerType::CompanyName, $entityContext, $formFieldNames);
		}
		elseif($k === 'UF_CONTACT_ID')
		{
			...
			{
				$entityData[$k] = __CrmQuickPanelViewPrepareClientInfo(CCrmOwnerType::ContactName, $entityContext, $formFieldNames);
			}
		}
		elseif($k === 'UF_DEAL_ID')
		{
