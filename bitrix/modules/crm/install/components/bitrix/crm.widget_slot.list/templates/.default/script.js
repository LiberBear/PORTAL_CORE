	...
	BX.CrmWidgetSlotNode.prototype =
	{
		...
		layout: function()
		{
			...
			fixedFieldWrapper.appendChild(
				BX.create("DIV",
					{
						props: { className: "crm-multi-field-value-wrapper crm-checkbox-container" },
			...
			var buttonWrapper = BX.create("DIV", { props: { className: "crm-multi-field-value-wrapper" } });
			cell.appendChild(
				BX.create("DIV",
					{
				...
				BX.create("DIV",
					{
						...
						children:
							[
								BX.create("DIV",
									{
										props: { className: "crm-multi-field-value-wrapper" },
										children:
										[
											BX.create("SPAN",
												{
...
if(typeof(BX.CrmWidgetSlotItem) === "undefined")
{
	...
	BX.CrmWidgetSlotItem.prototype =
	{
		...
		layout: function()
		{
			...
			if(this._mode === BX.CrmWidgetSlotItemMode.edit)
			{
				var optionWrapper = BX.create("DIV", { props: { className: "crm-multi-field-value-wrapper crm-checkbox-container" } });
				cell.appendChild(
					BX.create("DIV",
						{
							props: { className: "bx-crm-multi-field-wrapper" },
