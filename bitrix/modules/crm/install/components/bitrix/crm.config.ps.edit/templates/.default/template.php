...
<script type="text/javascript">
	...
	BX.crmPaySys.init({
		...
		requisiteFields: <?=CUtil::PhpToJsObject($arResult['REQUISITE_FIELDS'])?>,
		bankDetailFields: <?=CUtil::PhpToJsObject($arResult['BANK_DETAIL_FIELDS'])?>,
		companyFields: <?=CUtil::PhpToJsObject($arResult['CRM_COMPANY_FIELDS'])?>,
		contactFields: <?=CUtil::PhpToJsObject($arResult['CRM_CONTACT_FIELDS'])?>,
