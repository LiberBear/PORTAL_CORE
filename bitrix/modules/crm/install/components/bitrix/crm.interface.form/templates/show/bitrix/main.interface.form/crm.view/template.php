...
<div style="height: 100%;">
	...
	foreach($tab['fields'] as &$field):
		...
		$isEmptyField = empty($val) && $type !== 'crm_activity_list' && $type !== 'crm_deal_list' && $type !== 'crm_quote_list' && $type !== 'crm_invoice_list' && $type !== 'crm_company_list' && $type !== 'crm_contact_list' && $type !== 'crm_requisite_list' && $type !== 'crm_event_view' && $field['id'] !== 'COMMENTS';
