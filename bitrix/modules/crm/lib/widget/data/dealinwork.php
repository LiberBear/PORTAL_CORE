	...
	*/
	...
	public function getList(array $params)
	{
		...
		$queries = array(
			...
			self::prepareInvoiceQuery($periodStartDate, $periodEndDate, $responsibleIDs, $group)
		);
	 ...
	 * @return Query
	 */
	protected static function prepareInvoiceQuery($startDate, $endDate, $responsibleIDs = null, $group = '')
	{
	...
	public function prepareEntityListFilter(array $filterParams)
	{
		...
		$queries = array(
			...
			self::prepareInvoiceQuery($periodStartDate, $periodEndDate, $responsibleIDs)->getQuery()
		);
