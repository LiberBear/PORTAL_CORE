				...
				if (CMobile::getApiVersion() >= 4)
				{
					?><script>
						...
						oMSL.createCommentInputForm({
                            ...
                            mentionDataSource:   {outsection:false, url:(BX.message('MobileSiteDir') ? BX.message('MobileSiteDir') : '/')+"mobile/index.php?mobile_action=get_user_list&use_name_format=Y"},
