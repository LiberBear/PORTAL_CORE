...
if(typeof(BX.CrmClientListView) === "undefined")
{
	...
	BX.CrmClientListView.prototype._onAfterVisibilityChange = function()
	{
		if(this._searchContainer)
		{
			this._searchContainer.style.display = this._isVisible ? "" : "none";
			this._enableSearch = this._isVisible;
		}
	};
