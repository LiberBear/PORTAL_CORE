...
{
	?><div class="task-detail-error"><?=htmlspecialcharsbx($templateData["ERROR"]["MESSAGE"])?></div><?
	return;
}
				...
				"fields" => array(
					array(
						...
						"value" => (
							...
							($can["EDIT"] ? "<input id=\"title".$task["ID"]."\" type=\"hidden\" bx-type=\"text\" name=\"data[TITLE]\" value=\"".htmlspecialcharsbx($task["TITLE"])."\" />" : "").
...
/*					array(
						...
						"value" =>
							'<span class="mobile-grid-field-timetracking">Start</span>'.
							'<span class="mobile-grid-field-timer">'.
								'<span>00:00</span>&nbsp;/&nbsp;<span>00:00</span>'.
							'</span>'.
							'<span class="mobile-grid-field-controls"></span>'
					),
*/					(($mark = array(
...
/*					array(
						...
						"value" => "&nbsp;" // TODO How could I count this?
					),
*/					array(
...
BX.ready(function(){
	new BX.Mobile.Tasks.detail({
			...
			taskEditObj : new BX.Mobile.Tasks.edit(<?=CUtil::PhpToJSObject(array(
				"taskId" => $task["ID"],
				"checkListView" => $task["CHECKLIST"],
