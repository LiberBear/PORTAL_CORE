	...
	<div id="bx-mobile-interface-sort-block" class="mobile-grid-field-list">
		...
		<div class="mobile-grid-field mobile-grid-field-fixed">
			<div class="mobile-grid-button-panel">
				<a href="javascript:void(0)" ontouchstart="BX.Mobile.Grid.Sort.apply()"><?=GetMessage("M_SORT_BUTTON")?></a>
				<span class="mobile-grid-button-panel-divider"></span>
				<a href="javascript:void(0)" ontouchstart="BXMobileApp.UI.Page.close();"><?=GetMessage("M_SORT_CANCEL")?></a>
			</div>
		</div>
	</div>
<?
