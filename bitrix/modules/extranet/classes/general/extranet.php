...
class CExtranet
{
	...
	*/
	...
	public static function IsProfileViewable($arUser, $site_id = false, $bOnlyActive = true)
	{
		global $USER;
	...
	*/
	...
	public static function fillUserListFilterORM($arParams = array(), &$arFilter = array(), &$bFilteredByUserId)
	{
		...
		{
			$arFilteredUserIDs = array_merge($arFilteredUserIDs, CExtranet::GetMyGroupsUsersSimple(CExtranet::GetExtranetSiteID()));
		}
	...
	public static function OnGetProfileView($currentUserId, $arUser, $siteId, $arContext, $bOnlyActive = true)
	{
		...
		{
			return self::IsProfileViewable($arUser, $siteId, $bOnlyActive);
		}
		else
		{
			return false;
