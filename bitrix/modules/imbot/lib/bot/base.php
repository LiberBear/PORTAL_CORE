...
abstract class Base
{
	...
	public static function getBotOption($userId, $name, $value = false)
	{
		...
		return \CUserOptions::GetOption('imbot', $class::BOT_CODE.'_'.$name, $value, $userId);
	}
	...
	public static function setBotOption($userId, $name, $value)
	{
		...
		\CUserOptions::SetOption('imbot', $class::BOT_CODE.'_'.$name, $value, false, $userId);
	...
	public static function uploadAvatar()
	{
		...
		if (\Bitrix\Main\IO\File::isFileExists(\Bitrix\Main\Application::getDocumentRoot().'/bitrix/modules/imbot/install/avatar/'.$class::BOT_CODE.'/'.LANGUAGE_ID.'.png'))
		{
			$avatarUrl = \Bitrix\Main\Application::getDocumentRoot().'/bitrix/modules/imbot/install/avatar/'.$class::BOT_CODE.'/'.LANGUAGE_ID.'.png';
		}
